...
Projection-only loadings are currently computed in [projected_loadings.py](/Users/shaun/Library/CloudStorage/Dropbox/045%20-%20Vibing/ceiora-risk/backend/risk_model/projected_loadings.py).
...
Projection-only loadings are currently computed from the serving refresh path in [pipeline.py](/Users/shaun/Library/CloudStorage/Dropbox/045%20-%20Vibing/ceiora-risk/backend/analytics/pipeline.py).
