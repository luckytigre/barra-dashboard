...
def latest_neon_mirror_artifact_for_run(*, run_id: str) -> Path | None:
    return neon_mirror_reporting_service.latest_neon_mirror_artifact_for_run(run_id=run_id)
...
def repair_neon_sync_health_from_existing_workspace(
    *,
    ...
    return neon_mirror_reporting_service.repair_neon_sync_health_from_existing_workspace(
        run_id=run_id,
        profile=profile,
        as_of_date=as_of_date,
        workspace_sqlite_path=workspace_sqlite_path,
        workspace_cache_path=workspace_cache_path,
        prior_artifact_path=prior_artifact_path,
        dsn=dsn,
        source_years=source_years,
        analytics_years=analytics_years,
        latest_artifact_fn=latest_neon_mirror_artifact_for_run,
        run_parity_audit_fn=neon_mirror_service.run_bounded_parity_audit,
        write_artifact_fn=write_neon_mirror_artifact,
        publish_sync_health_fn=publish_neon_sync_health,
    )
